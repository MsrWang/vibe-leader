...
3.0 的四类自然语言请求见[日常项目用法](project-workflow.md)，判断修改位置与影响见[维护说明](maintenance-and-change.md)。3.0.1 修改了 Skill 主循环：只阅读说明无需安装；要让现有 3.0.0 或更早安装获得连续推进规则，需要按本页受控升级边界更新实际安装。证据与限制见[3.0.1 说明](release-3.0.1.md)，3.0.0 的原始范围见[3.0.0 说明](release-3.0.md)。
