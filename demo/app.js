...
(() => {
  const cases = {
    ...
    deviation: {
      purpose: '说不清技术原因时，恢复整体方向并继续主线',
      prompt: '使用 $vibe-project-lead-zh。以下只讨论合成案例：\n我感觉当前推进有偏差，但说不清技术原因。\n请根据整体目标、最新决定和当前行动给出最小修正；如果仍在已有授权内，说明后继续。',
      response: [
        ['纠偏判断', '当前行动正在围绕局部样式持续扩展，已经占据原定的三份使用指南主线；已有指南内容仍然有效。'],
        ['最小修正', '停止新增无关样式，保留已完成的有效内容，恢复三份指南的补齐和对应链接检查。'],
        ['现在继续', '按现有授权完成三份指南和本地检查；纠偏不增加发布、安装或其他外部动作权限。']
      ],
      next: '主管在已有授权内继续原主线；只有目标冲突、证据不足或需要新决定时才停下来询问。'
    },
    wrong: {
